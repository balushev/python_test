...
#  @In_test @new
  Scenario Template: Create a Quote for Home insurance (Home)
  """ This UI scenario testing creation of a quote for Home insurance (Home) """
    ...
    * Choose Habitation only for Add home => Home details page => "Habitation usage" options area* Pause
...
#    * Verify Offer congratulations message contains "Your proposition with number" text
    ...
    Scenarios: Test data for Car insurance (Add Car)
      | quoteInsurance | ownerFirstName | vehicleMake | vehicleModel | vehicleType   | firstUseDate | numberOfSeats | registrationNumber | chassisNumber | registrationType | fuelType   | usageType    | vehicleValue | accessoriesEquipment | claimNature | claimDate  | claimLiability | claimDriverType | claimDriverDateOfBirth | claimJokerUsed | claimAmount | claimRiskFullyRepaired | driverLicenseDate | driverLicenseCategory | certificates | coverageTariffs    | billingType   | billingFrequency | billingRenewalDay | billingRenewalMonth |
      | Car insurance  | Lamxxxxxxx     | peugeot     | 3008         | Passenger car | 09/09/2021   | 5             | CA1111CA           | 11183765      | Normal Plate     | Electric   | Private      | 30000        | 5000                 | Accident    | 08/08/2018 | 0 percent      | Primary         | 08/08/1980             | Yes            | 3000        | No                     | 12/02/2019        | B                     | No           | Own damage comfort | Direct credit | Annual           | 13                | 5                   |
      | Car insurance  | Lamxxxxxxx     | citroen     | jumper       | Minibus       | 09/09/2021   | 5             | CO13CA             | 46748gh7      | Trader plate     | Diesel oil | Professional | 50000        | 0                    | Fire        | 08/08/2018 | 100 percent    | Secondary       | 08/08/1980             | No             | 1530        | Yes                    | 12/02/2019        | BE                    | No           | Driver plus        | Direct credit | semi annual      | 10                | 3                   |
...
#  @new
  ...
  """ This UI scenario testing creation of a quote for Car insurance (Add Old timer) """
    ...
    * Click "Summary" button
    * Click "Submission" button
#    * Wait for <expectedResult> button

    Scenarios: Test data for Car insurance (Add Old timer)
      | quoteInsurance | ownerFirstName | vehicleMake | vehicleModel | vehicleVersion | vehicleType           | vehiclePower | firstUseDate | numberOfSeats | registrationNumber | chassisNumber | registrationType | fuelType | usageType | claimNature | claimDate  | claimLiability | claimDriverType | claimDriverDateOfBirth | claimJokerUsed | claimAmount | claimRiskFullyRepaired | driverLicenseDate | driverLicenseCategory | certificates | coverageTariffs       | billingType   | billingFrequency | billingRenewalDay | billingRenewalMonth | expectedResult   |
      | Car insurance  | Lamxxxxxxx     | Rolls Royce | Phantom      | 5              | Old timer private car | 100          | 09/09/1990   | 5             | O1111CA            | 11183765      | Normal Plate     | Electric | Private   | Accident    | 08/08/2018 | 0 percent      | Primary         | 08/08/1980             | Yes            | 3000        | No                     | 12/02/2019        | B                     | No           | legal assistance safe | Direct credit | Annual           | 13                | 5                   | Submit documents |
  ...
  """ This UI scenario testing creation of a quote for Car insurance (Add Van) """
    ...
    * Wait for <expectedResult> button
    ...
    Scenarios: Test data for Car insurance (Add Van)
      | quoteInsurance | ownerFirstName | vehicleMake | vehicleModel | vehicleVersion | vehicleType           | vehiclePower | firstUseDate | numberOfSeats | registrationNumber | chassisNumber | registrationType | fuelType | usageType | claimNature | claimDate  | claimLiability | claimDriverType | claimDriverDateOfBirth | claimJokerUsed | claimAmount | claimRiskFullyRepaired | driverlicenseDate | driverlicenseCategory | certificates | coverageTariffs       | billingType   | billingFrequency | billingRenewalDay | billingRenewalMonth | expectedResult   |
      | Car insurance  | Lamxxxxxxx     | PEUGEOT     | BOXER        | 5              | Old timer private car | 100          | 09/09/1990   | 5             | O1111CA            | 11183765      | Normal Plate     | Electric | Private   | Accident    | 08/08/2018 | 0 percent      | Primary         | 08/08/1980             | Yes            | 3000        | No                     | 12/02/2019        | B                     | No           | legal assistance safe | Direct credit | Annual           | 13                | 5                   | Submit documents |
...
#    * Wait for <expectedResult> button
    ...
    Scenarios: Test data for Car insurance (Add Truck Camper)
      | quoteInsurance | ownerFirstName | vehicleMake   | vehicleModel   | vehicleType | vehiclePower | firstUseDate | numberOfSeats | registrationNumber | chassisNumber | registrationType | fuelType | usageType | vehicleValue | accessoriesEquipment | claimNature | claimDate  | claimLiability | claimDriverType | claimDriverDateOfBirth | claimJokerUsed | claimAmount | claimRiskFullyRepaired | driverlicenseDate | driverlicenseCategory | certificates | coverageTariffs       | billingType   | billingFrequency | billingRenewalDay | billingRenewalMonth | expectedResult   |
      | Car insurance  | Lamxxxxxxx     | Mercedes-Benz | Grand Canyon S | Camping car | 100          | 09/09/1990   | 5             | O1111CA            | 11183765      | Normal Plate     | Electric | Private   | 75000        | 7500                 | Accident    | 08/08/2018 | 0 percent      | Primary         | 08/08/1980             | Yes            | 3000        | No                     | 12/02/2019        | B                     | No           | legal assistance safe | Direct credit | Annual           | 13                | 5                   | Submit documents |
...
#    * Wait for <expectedResult> button
    ...
    Scenarios: Test data for Family insurance
      | quoteInsurance   | ownerFirstName | branchOwner | familySituation | billingType   | billingFrequency | billingRenewalDay | billingRenewalMonth | addExtraInformation | expectedResult   |
      | Family insurance | Lamxxxxxxx     | NC          | 60 plus         | Direct credit | Annual           | 13                | 5                   | No                  | Submit documents |
...
#    * Wait for <expectedResult> button
    ...
    Scenarios: Test data for Motorcycle insurance (Add Motorcycle)
      | quoteInsurance       | ownerFirstName | make | model | vehicleType            | cubicCapacity | registrationNumber | chassisNumber | registrationType | fuelType | usageType | coverages              | billingType   | billingFrequency | billingRenewalDay | billingRenewalMonth |
      | Motorcycle insurance | Lamxxxxxxx     | BG   | Honda | Three wheel motorcycle | 100           | CA1111CA           | 1372918       | Normal Plate     | Electric | Private   | Legal assistance basis | Direct credit | Annual           | 13                | 5                   |
...
#    * Wait for <expectedResult> button
    ...
    Scenarios: Test data for Motorcycle insurance (Add Moped)
      | quoteInsurance       | ownerFirstName | make | model | vehicleType | cubicCapacity | registrationNumber | chassisNumber | registrationType | fuelType | usageType | coverages              | billingType   | billingFrequency | billingRenewalDay | billingRenewalMonth |
      | Motorcycle insurance | Lamxxxxxxx     | BG   | Honda | Class A     | 49            | CA1111CA           | 1372918       | Normal Plate     | Electric | Private   | Legal assistance basis | Direct credit | Annual           | 13                | 5                   |
