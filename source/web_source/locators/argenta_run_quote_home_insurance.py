...
add_family_add_home_home_details_page_next_button = add_home_home_details_page_next_button
...
add_family_add_home_home_details_page_abutment_options_tuple = add_home_home_details_page_abutment_options_tuple

add_family_add_home_home_details_page_building_year_dropdown = add_home_home_details_page_building_year_dropdown
add_family_add_home_home_details_page_building_year_dropdown_tuple = add_home_home_details_page_building_year_dropdown_tuple

add_family_add_home_home_details_page_habitation_usage_options_tuple = add_home_home_details_page_habitation_usage_options_tuple
add_family_add_home_home_details_page_irregular_habitation_options_tuple = add_home_home_details_page_irregular_habitation_options_tuple
add_family_add_home_home_details_page_flammable_construction_options_tuple = add_home_home_details_page_flammable_construction_options_tuple
