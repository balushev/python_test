...
options_area_lists = {
    ...
    'risk_acceptance_page_add_extra_information': ('no', 'yes'),
...
add_family_risk_acceptance_page_answer_no_button = 'button#ques-ans-item-question-answer-answer-boolean-toggle__FALSE_05-button'
...
home_branch_owner_dropdown = '#reference-element-extension-element-value-select'
home_branch_owner_dropdown_tuple = '#reference-element-extension-element-value-select_@index@'
...
risk_acceptance_page_add_extra_information_options_tuple = (
    'button#ques-ans-item-question-answer-answer-boolean-toggle__FALSE_00-button',
    'button#ques-ans-item-question-answer-answer-boolean-toggle__TRUE_00-button'
)
